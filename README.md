...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fc2418b1f62660016dba56a
...
To start editing your site, you can use the Sanity interface at https://scientific-sloth-2418b.sanity.studio/.
...
Generated at `2020-11-28T12:24:57.794Z` by Stackbit version `0.3.37`.